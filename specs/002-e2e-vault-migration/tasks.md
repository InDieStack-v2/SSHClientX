...
- [X] T112 Refuse export and legacy-vault migration on Android with messages naming the platform; permit fresh profile creation and verified sealed-vault import through the shared Rust paths, in `src-tauri/src/lib.rs` (FR-039, FR-040)
